...
public class ExerciseActivity extends AppCompatActivity
    ...
    // permission.ACCESS_FINE_LOCATION => WIFI, 모바일 데이터 사용
    // permission.ACCESS_COARSE_LOCATION => WIFI, 모바일 데이터, GPS 사용
    ...
    public void onLocationChanged(Location location) {
        ...
        Log.d(TAG,"onLocationChanged 실행");
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( ExerciseActivity.this, REQUIRED_PERMISSIONS,
